...
import { LayoutDashboard, Users, Settings, HelpCircle, Menu, X, LogOut ,ChevronDown } from 'lucide-react';
    ...
    <>
      ...
      >
        ...
        <div className={`flex items-center h-16 px-4 border-b ${isMobileMenuOpen ? 'justify-between' : 'justify-center'}`}>
          <Link to="/Home" className={`flex items-center ${isMobileMenuOpen ? 'ml-0' : 'flex-grow justify-center'}`}>
