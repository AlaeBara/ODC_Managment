...
import { LayoutDashboard, Calendar, Users, User, Menu, X, LogOut, ChevronDown, LibraryBig } from 'lucide-react';
...
const menuItems = [
  ...
  { id: 4, label: "Calendar", icon: Calendar, link: "/admin/Calendar" },
];
    ...
    <>
      ...
      >
        ...
        <div className=" flex flex-col items-center">
          ...
          <Link
            to="/admin/profile"
            className="border-t flex items-center justify-center w-full p-4 text-left hover:bg-muted transition-colors"
          >
            <User className="h-6 w-6 flex-shrink-0 text-orange-500" />
            <span className="ml-3 font-medium font-lato">Profile</span>
          </Link>
